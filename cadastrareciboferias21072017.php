...
$periodos_separados  = explode ("-",$periodo);
       ...
       $sql = mysql_query("update controle_ferias set dt_recibo_ferias = '$dt_recibo_ferias',dias_dt_recibo_ferias='$dias_dt_recibo_ferias' where matricula= '$matricula' and per_inicial= '$periodos_separados[0]' and per_final= '$periodos_separados[1]' and tipo_registro='NORMAL' ") or die(mysql_error());
...
<form name="form1" action="cadastrareciboferias21072017.php" method="POST" style="padding-top:40px;">
