...
<br><br>
<br>
<font size=4><b><u>Cadastro de Recibo</font></b></u>
...
if(isset($_POST['done'])){   		  
	...
	$dias_dt_recibo = $_POST['dias_recibo'];	
...
if ($controle_folga_periodo <> "Selecione..."){
		...
		if(empty ($matricula)||empty ($dt_recibo)||empty ($dias_dt_recibo)){
...
$periodos_separados  = explode ("-",$periodo);
       ...
       $sql = mysql_query("update controle_ferias set dt_recibo = '$dt_recibo',dias_dt_recibo='$dias_dt_recibo' where matricula= '$matricula' and per_inicial= '$periodos_separados[0]' and per_final= '$periodos_separados[1]' and tipo_registro='NORMAL' ") or die(mysql_error());
...
<form name="form1" action="cadastrarecibo14072017.php" method="POST" style="padding-top:40px;">
...
<tr>
<td>Dias Recibo:</td>
<td><input type="text"  name="dias_recibo" id="dias_recibo" maxlength="2" /> </td> 
</tr>
