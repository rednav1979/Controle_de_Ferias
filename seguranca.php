...
$_SG['senha'] = 'C0st4sul';                // Senha MySQL
$_SG['banco'] = 'tecnologia';            // Banco de dados MySQL

$_SG['paginaLogin'] = 'login_fail.php'; // Pсgina de login

$_SG['tabela'] = 'usuarios_controle_ferias';       // Nome da tabela onde os usuсrios sуo salvos
// ==============================
