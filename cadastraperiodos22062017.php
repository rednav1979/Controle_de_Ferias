...
<font size=4><b><u>Cadastro de Períodos</font></b></u>
...
$periodos_separados  = explode ("-",$periodo);
   ...
   //    $sql = mysql_query("update controle_ferias set per_fruicao1 = '$per_fruicao1',per_fruicao_11='$per_fruicao11' where matricula= '$matricula' and per_inicial= '$periodos_separados[0]' and per_final= '$periodos_separados[1]' ") or die(mysql_error());
	   $sql = mysql_query("INSERT INTO `controle_ferias`(`matricula`,`usuario`,`tipo_registro`,`ip`,`data_criacao`,`per_fruicao1`,`per_fruicao_11`,`per_inicial`,`per_final`) VALUES ('$matricula','$usuario','PERIODO','$ip',now(),'$per_fruicao1','$per_fruicao11','$periodos_separados[0]','$periodos_separados[1]')") or die(mysql_error());
...
<form name="form1" action="cadastraperiodos22062017.php" method="POST" style="padding-top:40px;">
