...
<blockquote>
<form name="form1" action="detalhamento22062017.php" method="POST" style="padding-top:40px;">
...
<br>
<a href=detalhamento_periodo18072017.php>Consulta Periodos...</a>
</blockquote>
...
// INICIO DA CONSULTA PERSONALIZADA
 ...
 $sqltudo = "SELECT * FROM `controle_ferias` where matricula = '$usuario_consulta' and tipo_registro='NORMAL' ORDER BY ID"; 				
		  $sqltudo = mysql_query($sqltudo); 		  
		  $colunas = mysql_num_rows($sqltudo);         
	   print'<br>';		
	   print'<br>';		   	
	   ...
	   print'<td><b>REC.I</td>';
	   print'<td><b>DIAS</td>';
	   print'<td><b>REC.II</td>';
	   print'<td><b>DIAS</td>';
	   print'<td><b>REC.III</td>';
	   print'<td><b>DIAS</td>';
	   print'</tr></b>';
	   $folga_total = 0;
	   $total_ferias = 0;
		   ...
		   $dias_dt_recibo2 = @mysql_result($sqltudo, $j, "dt_recibo_ferias2");
		   $dias_dt_recibo_ferias2 = @mysql_result($sqltudo, $j, "dias_dt_recibo_ferias2");
	...
	if ($tipo_registro == 'NORMAL'){
	   ...
	   print '<td>'.$dias_dt_recibo_ferias.'</td>';	  	   	   	
		...
		print '<td>-</td>';	  	   	   		
				...
				if ($dias_dt_recibo2 <>''){
	   print '<td>'.$dias_dt_recibo2.'</td>';	  	   	   
	        }else{
		print '<td>-</td>';	  	   	   		
			}			
				if ($dias_dt_recibo_ferias2 <>''){
	   print '<td>'.$dias_dt_recibo_ferias2.'</td>';	  	   	   	
	        }else{
		print '<td>-</td>';	  	   	   		
			}	  
...
// INICIO DA CONSULTA PERSONALIZADA
   ...
   @mysql_select_db($db);//selecione o banco de dados
           ...
           $sqltudo = mysql_query("SELECT * FROM `controle_ferias` where matricula = '$usuario_consulta'  ORDER BY ID")  or die(mysql_error()); 
           $colunas = mysql_num_rows($sqltudo);         
	   print'<br>';		
	   print'<br>';		   	
       print'<table border="1"   bordercolor="#00BFFF" >';
...
// INICIO DA CONSULTA PERSONALIZADA
   ...
   @mysql_select_db($db);//selecione o banco de dados
       ...
       $sqltudo = mysql_query("SELECT * FROM `controle_ferias` where matricula = '$usuario_consulta' and tipo_registro='PERIODO'  ORDER BY ID ")  or die(mysql_error()); 
       $colunas = mysql_num_rows($sqltudo);         
	   print'<br>';		
	   print'<br>';		   	
       print'<table border="1"   bordercolor="#00BFFF" >';
...
$intervalo_maisum = $intervalo_maisum + $intervalo->format('%R%a')+1;   
...
// INICIO DA CONSULTA PERSONALIZADA
   ...
   @mysql_select_db($db);//selecione o banco de dados
       ...
       $sqltudo = mysql_query("SELECT * FROM `controle_ferias` where matricula = '$usuario_consulta' and tipo_registro='PROGRAMA' ORDER BY ID ")  or die(mysql_error()); 
       $colunas = mysql_num_rows($sqltudo);         
	   print'<br>';		
	   print'<br>';		   	
       print'<table border="1"   bordercolor="#00BFFF" >';
